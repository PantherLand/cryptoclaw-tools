...
export const appConfig = {
  ...
  polymarket: {
    apiUrl: process.env.POLYMARKET_API_URL ?? "https://bridge.polymarket.com",
    statusPollMs: Number(process.env.POLYMARKET_STATUS_POLL_MS ?? 15_000),
    statusTimeoutMs: Number(process.env.POLYMARKET_STATUS_TIMEOUT_MS ?? 300_000)
  },
  hyperliquidTrading: {
