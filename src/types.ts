...
export interface DepositToPolymarketInput extends ExecutionFlags {
  sourceChain: ChainName;
  token: string;
  amount: string;
  destination: Address;
...
export interface WithdrawFromHyperliquidInput extends ExecutionFlags {
  destination: Address;
  amount?: string;
}
...
export interface PolymarketSupportedAsset {
  chainId: string;
  chainName: string;
  token: {
    name: string;
...
export interface PolymarketDepositQuote {
  sourceChain: ChainName;
  sourceToken: TokenInfo;
  amount: string;
  depositAddresses: PolymarketDepositAddresses;
  depositAddress: Address;
  destinationWallet: Address;
  supportedAsset: PolymarketSupportedAsset;
  quoteId?: string;
  estimatedCheckoutTimeMs?: number;
  estimatedInputUsd?: string;
  estimatedOutputUsd?: string;
  estimatedReceivedUsdcE: string;
  minimumReceivedUsdcE?: string;
